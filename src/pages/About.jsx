  ...
  return (
    <div>
      ...
      <Card>
        ...
        <img src={images.pedro} width={350} height={450} alt="Foto presentación personal"/>
        <Card.Body>
          ...
          <blockquote className="blockquote mb-0">
            ...
            <footer className="blockquote-footer">
              <ul>
                ...
                <li>
                  He aprendido a tomar más confianza y documentarme cada vez más
                  sin temor al error
                </li>
              </ul>
            </footer>
        ...
        <Card.Body>
          <blockquote className="blockquote mb-0">
            <p>E-mail:</p>
            <footer className="blockquote-footer">petter0915@gmail.com</footer>
          </blockquote>
        </Card.Body>
